...
export default function WorkWithUsSection() {
  return (
    <div className="relative py-24 overflow-hidden bg-gray-900 isolate sm:py-32">
      ...
      <div
        aria-hidden="true"
        className="absolute -translate-x-1/2 -top-52 left-1/2 -z-10 transform-gpu blur-3xl sm:-top-112 sm:ml-16 sm:translate-x-0"
      >
        <div
          style={{
            clipPath:
      ...
      <div className="px-6 mx-auto max-w-7xl lg:px-8">
        ...
        <div className="max-w-2xl mx-auto mt-10 lg:mx-0 lg:max-w-none">
          <div className="grid grid-cols-1 text-base font-semibold text-white gap-x-8 gap-y-6 sm:grid-cols-2 md:flex lg:gap-x-10">
            <a href="#">Open roles →</a>
